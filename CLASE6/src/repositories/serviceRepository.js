import ServiceMongoManager from "../managers/serviceMongoManager.js";

export default class ServiceRepository {
  constructor(services = new ServiceMongoManager()) {
  ...
  // agregamos buscarPorSlug
  async obtenerPorSlug(slug) {
    return await this.services.buscarPorSlug(slug);
  }
